...
using FamilyHubs.ServiceDirectory.Shared.Logging;
...
{
    public static void AddApplicationInsights(this IServiceCollection services, IConfiguration configuration, string appname)
    {
        services.AddApplicationInsightsTelemetry();
        services.AddApplicationInsightsTelemetryClient(configuration, appname);
        services.AddApplicationInsightsServiceName(configuration, appname);
        services.AddLogging(appname);
